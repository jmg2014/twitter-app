...
public class TimeHelper {
	...
	/**
	 * This method return the time between two LocalDateTime
	 *   
	 * if the difference is hours, it will return only the difference in hours excluding minutes and seconds
	 * if the difference is minutes, it will return only the difference in minutes excluding seconds
	 * if the difference is seconds, it will return the difference in seconds
	 * 
	 * @param from
	 *            initial time
	 * @param to
